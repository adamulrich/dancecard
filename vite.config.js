...
export default defineConfig({
  ...
  build: {
      ...
      rollupOptions: {
          ...
          edit_account_ward_lookup: resolve(__dirname, './src/edit_account_ward_lookup.html'),
          edit_account: resolve(__dirname, './src/edit_account.html'),
          edit_user_select_stake: resolve(__dirname, './src/edit_user_select_stake.html'),
          ...
          edit_stake_js: resolve(__dirname, './src/scripts/edit_account_stake_lookup.js'),
          edit_ward_js: resolve(__dirname, './src/scripts/edit_account_ward_lookup.js'),
          edit_account_js: resolve(__dirname, './src/scripts/edit_account.js'),
          ...
          main_admin_schedule_js: resolve(__dirname, './src/scripts/main_admin_schedule.js'),
          main_admin_js: resolve(__dirname, './src/scripts/main_admin.js'),
